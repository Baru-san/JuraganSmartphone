...
public class Database {
    ...
    public Database(){
        this.fileRecordPembelian = "src/main/java/Databases/RecordPembelian.txt";
        this.fileSmartphone = "src/main/java/Databases/Data_Andro.txt";
    ...
    private String[] DataSmartphone(){
        ...
        try(FileReader fileReader = new FileReader(fileSmartphone);
        BufferedReader smartphone = new BufferedReader(fileReader);) {
            smartphone.mark(500);
            smartphone.reset();
